...
# Class Movie, subclass of Video defines a more specific storage container
# for Movie objects
#
...
class Video():
    ...
    def __init__(self, title, duration, year):
        # initialize video_title, video_duration and video_year
        # instance attributes
...
# Class Movie - subclass of Video that also holds additional movie
# specific information
class Movie(Video):
    """
    This class represents a Movie object. It is being inherited
    from class Video. As such, it inherits attributes video_title and
    video_duration from its parent class.
    ...
    def __init__(self,
                 ...
                 poster_url,
                 trailer_url):
        # Call the parent constructor to populate video_title,
        # video_duration and video_year
        Video.__init__(self, title, duration, year)
        # initialize movie_storyline, movie_poster_url and movie_trailer_url
        # instance attributes
